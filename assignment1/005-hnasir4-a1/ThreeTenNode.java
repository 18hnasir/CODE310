...
/**
 * This class represents a node for the SimGUI graph. Remember that your graph
 * class is generic, so it shouldn't assume that all nodes are ThreeTenNodes.
 * 
 * @author Katherine (Raven) Russell
 */
class ThreeTenNode extends ThreeTenGraphComponent {
	/**
	 * The ID for the next node to be created. This auto-increments with ever
