/**
 * Class used as a demo for the hashtables.
 * 
...
class DemoProgram {
	...
	/**
	 * Method used for demoig of the hashtables.
	 * 
	 * @param useTable1 to be used.
	 */
			...
			while (true) {
				...
				switch (choice) {
					case 1: // put
						...
						System.out.println(((size == (useTable1 ? table1.size() : table2.size())) ? "Updated" : "Added")
								+ " value at key.");
						pauseForUser(input);
						break;
					case 2: // get
					...
					case 3: // remove
						...
						System.out
							.println((value == null) ? "No such key" : "Removed pair was (" + key + "," + value + ")");
						pauseForUser(input);
						break;
					case 4: // resize
	...
	/**
	 * Method used to help demo hashtables.
	 * 
	...
	/**
	 * Method used help demo the hashtables.
	 * 
	 * @param input  to be used
